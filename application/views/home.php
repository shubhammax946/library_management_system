...
<p class="help-block"><a href="http://localhost/ci/forgot.php">Forgot Password</a></p>
</div>



 <a href="k.php" ><button type="submit" name="login"  class="btn btn-info">LOGIN </button></a> | <a href="index.php#usignup">Not Register Yet</a>
